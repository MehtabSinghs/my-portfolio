...
const Work = ({ onCaseStudies }) => {
  // 👉 Later, just replace `link: ""` with your real Figma share URLs
  const projects = [
    {
...
const Footer = () => (
  <footer className="footer">
    {/* <p>© {new Date().getFullYear()} Mehtab Singh · UI/UX & Product Designer</p> */}
...
const App = () => {
  ...
  return (
    <div className="page">
      ...
      <Nav onCaseStudies={() => setCurrentPage("caseStudies")} />
      <main>
        <Hero />
        <Work onCaseStudies={() => setCurrentPage("caseStudies")} />
        <Process />
        <Skills />
        <Testimonials />
        <About />
